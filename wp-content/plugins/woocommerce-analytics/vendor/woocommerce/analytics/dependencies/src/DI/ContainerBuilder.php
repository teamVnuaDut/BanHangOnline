...
use Automattic\WooCommerce\Analytics\Dependencies\DI\Compiler\Compiler;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Source\AnnotationBasedAutowiring;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Source\DefinitionArray;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Source\DefinitionFile;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Source\DefinitionSource;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Source\NoAutowiring;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Source\ReflectionBasedAutowiring;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Source\SourceCache;
...
class ContainerBuilder
{
    ...
    /**
     * If PHP-Automattic\WooCommerce\Analytics\Dependencies\DI is wrapped in another container, this references the wrapper.
    ...
    public function build()
    {
        ...
        if ($this->sourceCache) {
            if (!SourceCache::isSupported()) {
                throw new \Exception('APCu is not enabled, PHP-Automattic\WooCommerce\Analytics\Dependencies\DI cannot use it as a cache');
            }
     ...
     * set this so that PHP-Automattic\WooCommerce\Analytics\Dependencies\DI will use the wrapper rather than itself for building objects.
     *
     * @return $this
     */
     ...
     *   PHP-Automattic\WooCommerce\Analytics\Dependencies\DI knows about them and compiles them

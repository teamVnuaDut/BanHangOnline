...
class Compiler
{
     ...
     * if PHP-Automattic\WooCommerce\Analytics\Dependencies\DI configuration does not change.
     *
     * @var int
     */
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
        ...
        if (!$isOptional) {
            throw new \Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
        }
        return $defaultValue;
PHP;
                break;
    ...
    /**
     * @throws \Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Exception\InvalidDefinition
     */

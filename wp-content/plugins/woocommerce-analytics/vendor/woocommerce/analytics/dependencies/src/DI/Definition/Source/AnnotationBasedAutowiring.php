...
use Automattic\WooCommerce\Analytics\Dependencies\DI\Annotation\Inject;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Annotation\Injectable;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Exception\InvalidAnnotation;
...
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\ObjectDefinition\PropertyInjection;
use Automattic\WooCommerce\Analytics\Dependencies\DI\Definition\Reference;
use Doctrine\Common\Annotations\AnnotationRegistry;
use Doctrine\Common\Annotations\Reader;
use Doctrine\Common\Annotations\SimpleAnnotationReader;
use InvalidArgumentException;
use Automattic\WooCommerce\Analytics\Dependencies\PhpDocReader\PhpDocReader;
use ReflectionClass;
...
/**
 * Provides Automattic\WooCommerce\Analytics\Dependencies\DI definitions by reading annotations such as @ Inject and @ var annotations.
 *
...
class AnnotationBasedAutowiring implements DefinitionSource, Autowiring
{
    ...
    /**
     * @var Automattic\WooCommerce\Analytics\Dependencies\PhpDocReader
     */
    ...
    private function readProperty(ReflectionProperty $property, ObjectDefinition $definition, $classname = null)
    {
        ...
        $annotation = $this->getAnnotationReader()->getPropertyAnnotation($property, 'Automattic\WooCommerce\Analytics\Dependencies\DI\Annotation\Inject');
    ...
    private function getMethodInjection(ReflectionMethod $method)
    {
        // Look for @Inject annotation
        try {
            $annotation = $this->getAnnotationReader()->getMethodAnnotation($method, 'Automattic\WooCommerce\Analytics\Dependencies\DI\Annotation\Inject');
    ...
    public function getAnnotationReader()
    {
        if ($this->annotationReader === null) {
            ...
            $this->annotationReader->addNamespace('Automattic\WooCommerce\Analytics\Dependencies\DI\Annotation');
        }
    ...
    /**
     * @return Automattic\WooCommerce\Analytics\Dependencies\PhpDocReader
     */
    ...
    private function readInjectableAnnotation(ReflectionClass $class, ObjectDefinition $definition)
    {
        try {
            ...
            $annotation = $this->getAnnotationReader()
                ->getClassAnnotation($class, 'Automattic\WooCommerce\Analytics\Dependencies\DI\Annotation\Injectable');
